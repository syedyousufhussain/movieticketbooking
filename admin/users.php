...
?>
									...
									<td>
										<div class="catalog__user">
											...
											<div class="catalog__meta">
												<h3><?php echo $row['u_email'] ?></h3>
												<!-- <span>email@email.com</span> -->
											</div>
										</div>
									</td>
									<td>
										<div class="catalog__text"><?php echo $row['u_name'] ?></div>
									</td>
									<td>
										<div class="catalog__text">Premium</div>
									</td>
									<td>
										<div class="catalog__text"><?php echo $row['u_phone'] ?></div>
									</td>
									<td>
										<div class="catalog__text"><?php echo $row['u_address'] ?></div>
									</td>
									<td>
										<div class="catalog__text catalog__text--green"><?php echo $row['u_role'] ?></div>
									</td>
									<td>
	...
	<img src="img/cover.jpg" class="background-image" alt="">
