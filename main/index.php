							...
							<ul class="splide__list">
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/venom.jpg">
										<div class="hero__content">
											<h2 class="hero__title">pider-Man 2 Venom<sub class="green">9.8</sub></h2>
								...
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/jurassicpark.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Jurassic world: Rebirth<sub class="yellow">6.9</sub></h2>
								...
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/kong.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Godzilla: attack of titans <sub class="red">6.2</sub></h2>
...
<?php
include('connect.php');
$select = "SELECT * FROM `movie_upload` limit 6";
